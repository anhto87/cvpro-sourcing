...
const convertSuggestJob = (jobs) => {
    ...
    for (let index = 0; index < jobs.length; index++) {
        ...
        items.push({ expiredDate, publishedDate, link, onlineDate, jobType, jobLocations, skills, benefits, locations, _id, domain, jobId, jobTitle, companyLogo, company, companyId, jobDescription, jobRequirement, salary })
    }
    return items
}
